...
impl Model {
  ...
  pub fn vertices(&self) -> &Vec<(f32,f32,f32)> { &self.vertices }
  pub fn lines(&self) -> &Vec<(u8,u8)> { &self.lines }
  pub fn triangles(&self) -> &Vec<(u8,u8,u8)> { &self.triangles }
